<?php
  ...
  $sql = "SELECT * FROM restaurant WHERE location = '정문'; ";
...
<head>
 ...
 <body>
  ...
  <nav class="navbar navbar-expand-sm bg-light">
    <ul class="nav navbar-nav w-100 nav-justified">
      <li class="nav-item">
        <a class="nav-link " href="location_market.php">시장</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="location_maingate.php">정문</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="location_backgate.php">후문</a>
      </li>
    </ul>
  </nav>
